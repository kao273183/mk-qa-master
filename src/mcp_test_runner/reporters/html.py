...
<title>Test Report — MCP Test Runner</title>
<style>
  :root {
    --bg: #0D1117;
    --bg-elevated: #161B22;
...
<div class="wrap">
  ...
  <header class="header">
    <div class="logo">MTR</div>
    <h1><span class="breadcrumb">MCP Test Runner /</span> Test Report</h1>
    <div class="meta">
  ...
  <footer>
    ...
    <a href="https://github.com/kao273183/mcp-test-runner">github.com/kao273183/mcp-test-runner</a>
  </footer>

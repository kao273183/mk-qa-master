"""HTML report generator — runner-agnostic, self-contained, TestBridge-styled."""
import base64
...
<title>Test Report — TestBridge Runner</title>
<style>
  :root {
    --bg: #0D1117;
    --bg-elevated: #161B22;
...
<div class="wrap">
  ...
  <header class="header">
    ...
    <h1><span class="breadcrumb">TestBridge Runner /</span> Test Report</h1>
    <div class="meta">
  ...
  <footer>
    Generated by <strong style="color: var(--text);">TestBridge Runner</strong> ·
    <a href="https://testbridge.chenjundigital.com/">testbridge.chenjundigital.com</a> ·
    © {{YEAR}} 宸鈞數位
  </footer>
